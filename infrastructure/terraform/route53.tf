...
# RUN terraform import aws_route53_zone.main Z0075900JI3Y3PVBRJSK
...
# ############################################################################
# # Change load balancer to this:
# # ===== LOAD BALANCER HTTPS LISTENERS =====

# # HTTPS Listener for Frontend Load Balancer
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.frontend.arn  # Replace with your actual target group
#   }
# }

# # HTTPS Listener for API Load Balancer
...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.api.arn  # Replace with your actual target group
#   }
# }
